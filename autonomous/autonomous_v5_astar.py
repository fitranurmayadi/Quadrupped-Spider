...
def main():
    print("==================================================")
    print("   V5: GLOBAL PATH PLANNING (A*) ")
    print("==================================================")
    ...
    print("  - Controller     : A* Path Planning + Pure Pursuit")
    ...
    # 4. Global Path Planning (A*)
    print("[INFO] Generating Occupancy Grid and running A* Search...")
    grid_map = GridMap(resolution=0.1, safe_margin=0.15)
    for pos, w, l in obstacles:
        grid_map.add_box_obstacle(pos[0], pos[1], w, l)
        
    global_path = a_star_search(grid_map, start_point, target_point)
    if not global_path:
        print("[ERROR] No path found by A*!")
        sys.exit(1)
        
    print(f"[INFO] A* Path found with {len(global_path)} waypoints.")
